...
import requirePropFactory from '@material-ui/core/utils/requirePropFactory';
import withStyles from '@material-ui/core/styles/withStyles';
import styles from '@material-ui/core/Grid/Grid';
...
//       [classes[`grid-xl-${String(mobile)}`]]: mobile !== false,
//       [classes[`grid-xl-${String(tablet)}`]]: tablet !== false,
//       [classes[`grid-xl-${String(desktop)}`]]: desktop !== false,
//     },
//     classNameProp,
//   );
...
if (process.env.NODE_ENV !== 'production') {
  ...
  StyledGrid.propTypes = {
    ...
    md: requireProp('item'),
    sm: requireProp('item'),
    mobile: requireProp('item'),
    tablet: requireProp('item'),
    desktop: requireProp('item'),
