...
export const styles = (theme: any) => ({
  ...
  ...theme.breakpoints.keys.reduce((accumulator: any, key: any) => {
...
const Grid:any = React.forwardRef(function Grid(props, ref) {
  ...
  const className = clsx(
    classes.root,
    {
      ...
      [classes[`grid-desktop-${String(desktop)}`]]: desktop !== false,
      [classes[`grid-tablet-${String(tablet)}`]]: tablet !== false,
      [classes[`grid-mobile-${String(mobile)}`]]: mobile !== false,
    },
    classNameProp,
  );
